package com.meriga.mfinance.config;
...
public class LiquibaseConfiguration {
    ...
    public SpringLiquibase liquibase(@Qualifier("taskExecutor") Executor executor,
        ...
        if (env.acceptsProfiles(Profiles.of(JHipsterConstants.SPRING_PROFILE_NO_LIQUIBASE, JHipsterConstants.SPRING_PROFILE_TEST, JHipsterConstants.SPRING_PROFILE_PRODUCTION))) {
